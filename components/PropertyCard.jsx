  ...
  return (
    <div className="bg-white rounded-xl shadow-md relative">
      <Image
        ...
        height={0}
        width={0}
        className="w-full object-cover rounded-t-xl brightness-50"
      />
      <div className="p-4">
        ...
        <h3 className="absolute top-[10px] right-[10px] px-4 py-2 text-white font-bold text-right md:text-center lg:text-right bg-gray-800 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border border-gray-100">
          ${getRates()}
        </h3>
